...
Cette grille va vous permettre de pré-évaluer votre travail. Vous devez la remplir grâce au symbole ✗ et la placer en haut de votre fichier README.md. La non-complétion de la grille entraînera des malus.
...
| Type  | Objectif | Fait | En partie | Pas fait |
| ----- | -------- | ---- | --------- | -------- |
